...
If you want to change the environment frequently you can change your npm commands in your package.json to something like this:
```
"ng:serve": "ng serve -o --env=${ENV:-local}",
```
If your ENV variable is not set it will serve the app with the local environment.

And this will now serve your app with the prod environment:
```
export ENV=prod
npm start
```

And this will now serve your app with the dev environment:
```
export ENV=dev
npm start
```
